...
This foundational increment does not provide authenticated multi-user ownership, encryption at rest, semantic personal retrieval, or a general secret detector. Local files inherit the configured storage backend and operating-system protections. The follow-up [personal-memory user control Note](2026-08-25-leon-personal-memory-control.md) adds consultation, correction, deletion, and disabling without merging personal and project records; export and backup controls remain future work.
