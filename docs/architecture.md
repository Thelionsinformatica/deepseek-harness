...
The Windows desktop application in [`apps/desktop`](../apps/desktop/README.md) (`@deepseek-ai/dsh-desktop`) starts the same Web profile in Electron's main process on loopback and loads it in a hardened native window.
