...
export const zh = {
  ...
  'settings.technicalContext.title': '聊天中的技术上下文',
  'settings.technicalContext.description': '显示系统指令、技能和时间等提示词准备事件',
  'settings.technicalContext.hidden': '隐藏',
  'settings.technicalContext.shown': '显示',
...
export const en = {
  ...
  'settings.technicalContext.title': 'Technical context in chat',
  'settings.technicalContext.description': 'Show prompt preparation events such as system instructions, skills, and time',
  'settings.technicalContext.hidden': 'Hidden',
  'settings.technicalContext.shown': 'Shown',
