...
export const zh = {
  ...
  'message.failover.title': '本地模型不可用',
  'message.failover.detail': 'Leon 已自动通过配置的 API 切换到 {model}。',
...
export const en = {
  ...
  'message.failover.title': 'Local model unavailable',
  'message.failover.detail': 'Leon automatically switched to {model} through the configured API.',
