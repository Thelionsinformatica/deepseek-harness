...
/**
 * Display transform for host-configured names outside the built-in permission
 * set. Conventional kebab-case names render in title case; custom labels pass
 * through unchanged.
 */
...
function optionLabel(
  ...
  if (option.value === FULL_ACCESS) return t('access.fullAccess')
