...
/** Field controlling whether prompt-assembly events are rendered in chat. */
export const SHOW_TECHNICAL_CONTEXT_FIELD = 'showTechnicalContext'
...
/** Prompt preparation stays available for diagnostics, but out of normal chat. */
export const DEFAULT_SHOW_TECHNICAL_CONTEXT = false
...
export interface ConversationSettings {
  ...
  /** Whether non-user context injection rows are visible in the transcript. */
...
export const ConversationSettingsSchema: z<ConversationSettings> = z.object({
  ...
  [SHOW_TECHNICAL_CONTEXT_FIELD]: z.boolean().default(DEFAULT_SHOW_TECHNICAL_CONTEXT),
})
