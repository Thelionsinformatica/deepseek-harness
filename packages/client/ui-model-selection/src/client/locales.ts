...
export const zh = {
  ...
  'automatic.description': '从本地 Qwen 开始，按任务难度提高推理强度；只有本地路由失败且获得授权后才使用外部 API',
...
export const en = {
  ...
  'automatic.description': 'Starts with local Qwen, raises its reasoning effort for harder work, and uses an external API only after a local failure and explicit consent',
...
export const pt = {
  ...
  'automatic.description': 'Começa com o Qwen local, aumenta o esforço conforme a dificuldade e só usa API após falha local e autorização.',
