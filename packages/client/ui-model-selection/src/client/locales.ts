...
export const zh = {
  ...
  'automatic.description': '按任务使用部署方配置的路由——文本可走已保存的默认模型；仅在部署声明了外部备用路由且获得授权后才启用外部备用',
  ...
  'menu.aria': '模型与推理等级',
  'menu.guidance': '自动模式使用宿主配置的路由。手动选择是可选的，不会授予外部访问权限。',
  'menu.model': '模型',
  'menu.effort': '推理等级',
...
export const en = {
  ...
  'automatic.description': 'Uses the route this deployment configured for each task — text may follow your saved default model; an external fallback applies only when the deployment declares one and you consent',
  ...
  'menu.guidance': 'Automatic mode uses Host-configured routes. Manual selection is optional and does not grant external access.',
  'menu.model': 'Model',
  'menu.effort': 'Effort',
  'effort.providerDefault': 'Default',
...
export const pt = {
  ...
  'automatic.description': 'Usa a rota configurada pelo perfil para cada tarefa — o texto pode seguir o modelo padrão salvo. Fallback externo só entra quando o perfil declara um e você autoriza.',
  ...
  'menu.guidance': 'Descreva a tarefa ao Leon. O automático usa as rotas configuradas. A seleção manual é opcional e não autoriza acesso externo.',
  'menu.model': 'Modelo manual (avançado)',
  'menu.effort': 'Esforço manual (avançado)',
