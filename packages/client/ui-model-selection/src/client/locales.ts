...
export const zh = {
  ...
  'automatic.description': '先以最低推理强度使用本地 9B 模型，中等任务提高推理强度，复杂任务调用已配置的云端模型',
  'menu.aria': '模型与推理等级',
  'menu.model': '模型',
  'menu.effort': '推理等级',
...
export const en = {
  ...
  'automatic.description': 'Uses the local 9B model at minimum effort, raises its effort for medium work, and calls the configured cloud model for complex work',
