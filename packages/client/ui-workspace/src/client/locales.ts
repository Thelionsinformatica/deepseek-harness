...
export const zh = {
  ...
  'delete.session.description': '要永久删除“{name}”及其会话历史吗？此操作无法撤销。不会删除其工作区中的文件，个人记忆也会单独保留。',
  'delete.session.pending': '正在删除会话…',
  'archived.title': '已归档会话',
  'archived.open.aria': '已归档会话：{n}',
  'archived.description': '已归档会话会保留在此电脑上，直到您将其恢复或永久删除。',
  'archived.empty': '暂无已归档会话',
  'archived.unavailable': '会话不可用',
  'archived.restore': '恢复',
  'archived.restore.aria': '恢复“{name}”',
  'archived.restoring': '正在恢复会话…',
  'archived.delete': '永久删除',
  'archived.delete.aria': '永久删除“{name}”',
...
export const en = {
  ...
  'delete.session.description': 'Permanently delete “{name}” and its conversation history? This cannot be undone. Files in its workspace are not deleted, and personal memory is kept separately.',
  'delete.session.pending': 'Deleting conversation…',
  'archived.title': 'Archived conversations',
  'archived.open.aria': 'Archived conversations: {n}',
  'archived.description': 'Archived conversations stay on this computer until you restore or permanently delete them.',
  'archived.empty': 'No archived conversations',
  'archived.unavailable': 'Conversation unavailable',
  'archived.restore': 'Restore',
  'archived.restore.aria': 'Restore {name}',
  'archived.restoring': 'Restoring conversation…',
  'archived.delete': 'Delete permanently',
  'archived.delete.aria': 'Permanently delete {name}',
