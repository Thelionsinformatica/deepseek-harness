...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'knowledge_search', 'knowledge_status', 'list_agents', 'list_agents', 'lsp', 'memory_forget', 'memory_remember',
      'memory_search', 'memory_update', 'personal_memory_forget', 'personal_memory_remember',
      'personal_memory_search', 'personal_memory_update', 'pwsh', 'pwsh', 'ralph',
