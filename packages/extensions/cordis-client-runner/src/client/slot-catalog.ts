...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, manual-compaction, model-failover, model-retry, steering, task-validation, tool-call, turn-error, turn-max-tokens, turn-tail, unknown, user, workflow-run',
    hookContext: 'string',
    ...
    occupants: [
      'client-ui-conversation TaskValidationView key \'task-validation\'',
      ...
      'client-ui-conversation ModelFailoverNodeView key \'model-failover\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-voice VoiceActivity id \'voice-activity\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional product dashboard rendered in the blank-session Hero between the headline and Workspace controls.',
    doc: 'Optional product dashboard rendered in the blank-session Hero between\nthe headline and Workspace controls. Root scope gives the occupant the\nglobal Session and Workspace hooks without tying its cards to the\nprovisional blank Session.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-work-dashboard WorkDashboard',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-web-access WebAccessControl id \'web-access\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-work-dashboard MemoryReviewButton id \'memory-review\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation ActivityControls id \'activity\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-conversation TechnicalContextRow id \'technical-context\'',
