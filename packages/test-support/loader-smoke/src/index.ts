...
const DEFAULT_PROCESS_TIMEOUT_MS = process.platform === 'win32' ? 60_000 : 30_000

/** Vitest deadline that leaves room for the platform-aware subprocess diagnostic timeout. */
