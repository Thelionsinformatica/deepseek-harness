...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  lsp: 'lsp.md',
  memory: 'memory.md',
  memoryContinuity: 'memory.md',
  personalMemory: 'memory.md',
  memoryCandidateReview: 'memory.md',
  procedureLearning: 'memory.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  taskAcceptance: 'function-valued object facade, not a class service; packages/guard/completion-claim-policy/README.md owns createAcceptanceTask',
  ...
  resolveDefaultWorkspace: 'not a service: boot-provided root accessor function for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  MemoryCreateRequest: 'memory.md',
  MemoryContinuityDomainSource: 'memory.md',
  MemoryContinuityDomainTarget: 'memory.md',
  MemoryContinuitySnapshot: 'memory.md',
  MemoryContinuityImportResult: 'memory.md',
  MemoryCandidateRecord: 'memory.md',
  MemoryCandidateReviewListRequest: 'memory.md',
  MemoryCandidateReviewListResult: 'memory.md',
  MemoryCandidateReviewMarkRequest: 'memory.md',
  MemoryCandidateReviewMarkResult: 'memory.md',
  MemoryAdminCorrectRequest: 'memory.md',
  MemoryAdminCorrectResult: 'memory.md',
  MemoryAdminForgetRequest: 'memory.md',
  MemoryAdminForgetResult: 'memory.md',
  MemoryAdminListRequest: 'memory.md',
  MemoryAdminListResult: 'memory.md',
  ...
  PersonalMemoryAdminToggleRequest: 'memory.md',
  PersonalMemoryAdminToggleResult: 'memory.md',
  MemoryBlockedEvent: 'memory.md',
  ...
  PersonalMemoryBlockedEvent: 'memory.md',
  PersonalMemoryCreateRequest: 'memory.md',
  PersonalMemoryForgetRequest: 'memory.md',
  PersonalMemoryListPage: 'memory.md',
  PersonalMemoryListRequest: 'memory.md',
  PersonalMemoryOperationEvent: 'memory.md',
  PersonalMemoryProvider: 'memory.md',
  PersonalMemoryRecord: 'memory.md',
  PersonalMemoryScope: 'memory.md',
  PersonalMemorySearchHit: 'memory.md',
  PersonalMemorySearchRequest: 'memory.md',
  PersonalMemoryUpdateRequest: 'memory.md',
  ...
  ProcedureReuseResult: 'memory.md',
  ProcedureRevokeRequest: 'memory.md',
